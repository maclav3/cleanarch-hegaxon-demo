...
func (s *Service) AddFixtures() {
	assertNoError(s.ReaderRegistry.Add(reader.Add{
		ID:   "1",
		Name: "Reader1",
	}))
	assertNoError(s.ReaderRegistry.Activate(reader.Activate{
		ID: "1",
	}))
	assertNoError(s.ReaderRegistry.Add(reader.Add{
		ID:   "2",
	...
	assertNoError(s.BookInventory.Add(book.Add{
		ID:     "3",
		Author: "Author3",
		Title:  "Title3",
	}))
	...
	assertNoError(s.BookInventory.Loan(book.Loan{
		BookID:   "3",
		ReaderID: "1",
	}))
	assertNoError(s.BookInventory.Loan(book.Loan{
	...
	loanedList, err := s.BookInventory.List(book.ListQuery{
	...
	unloanedList, err := s.BookInventory.List(book.ListQuery{
